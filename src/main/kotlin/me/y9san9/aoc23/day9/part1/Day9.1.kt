package me.y9san9.aoc23.day9.part1
...
private data class Parameter(val values: List<Int>)
...
private fun main() {
    ...
    fun getNextValue(values: List<Int>): Int {
        ...
        return values.last() + getNextValue(values.windowed(size = 2) { (a, b) -> b - a })
    }
    val sum = parameters.sumOf { getNextValue(it.values) }
    println(sum)
}
// SCAFFOLD
...
private fun inputFile(): File = File(
    ...
    "src/main/kotlin/me/y9san9/aoc23/day9/part1/Input.txt"
)
