package me.y9san9.aoc23.day8.part1

import me.y9san9.aoc23.day8.part1.Turn.Left
import me.y9san9.aoc23.day8.part1.Turn.Right
import java.io.File
...
private fun main() {
    ...
    tailrec fun findPathLength(
        ...
        if (nextNode.id == BinaryNode.FINAL_ID) return turnsAcc
    ...
    val length = findPathLength(
        turns = turns.iterator(),
        tree = tree,
        node = nodes.getValue(BinaryNode.START_ID)
    )
...
private fun inputFile(): File = File(
    ...
    "src/main/kotlin/me/y9san9/aoc23/day8/part1/Input.txt"
)
